# clone-pic-pay
This  app was created based in a youtuber`s tutorial. (Mateus Silva)

Este é o repositório com o código fonte desenvolvido durante as aulas onde criamos um clone do aplicativo PicPay utilizando React Native, Styled Components e React Navigation 5.
...
Depois disso crie uma pasta para a aula e instale as dependências executando o seguinte comando:
```sh
